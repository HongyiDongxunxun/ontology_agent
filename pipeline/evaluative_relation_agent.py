...
## 评价客体类型限定
评价客体（object）必须是以下类型之一的实体，其他类型不应作为评价对象抽取：
可抽取的评价客体类型：
- 学者、研究人员、作者
- 机构、组织、团队、实验室、院系
- 国家、地区、区域
...
不可抽取的非评价客体类型（概念/方法/技术类，即使带有评价色彩也不抽取）：
- 概念、术语、方法、技术（如"开源大模型""深度学习""区块链""联邦学习"）
- 理论、模型、算法（如"神经网络""支持向量机""Transformer"）
- 工具、平台、系统（除非是作为具体项目或产品名称被评价）
- 数据、数据集、语料库

例：
"开源大模型性能优异" -> 不要抽取评价关系。开源大模型是概念/技术，不是评价客体。
"某机构的研究水平较高" -> object=某机构, aspect=研究水平, opinion=较高。
